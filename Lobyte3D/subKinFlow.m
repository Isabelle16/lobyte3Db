function [flowThick] = subKinFlow(flowThick,  nbrGrads, glob, y, x)
...
%     nbrGrads(3) = nbrGrads(3)*1.4;
%     nbrGrads(2) = nbrGrads(2)*1.2;
%     nbrGrads(4) = nbrGrads(4)*1.2;
%     nbrGrads(5) = nbrGrads(5)*1.05;
%     nbrGrads(1) = nbrGrads(1)*1.05;
